...
PROJECT_PATH ='/content/drive/My Drive/Research Works/Incremental Sequential Pattern mining/Experiment/Implementation/INCSPTree_BPFSPTree/Colab-Version/'

#from INC_SP_Tree import INC_SP_Tree_Node
#from INC_SP_Tree import INC_SP_Tree_Functionalities
inc_sp_tree_module = SourceFileLoader('INC_SP_Tree', join(PROJECT_PATH, 'INC_SP_Tree.py')).load_module()
...
class Main:
    def __init__(self):
        ...
        self.seq_sum_dict={}
        self.pass_no = 0
        self.inc_sp_tree_root = inc_sp_tree_module.INC_SP_Tree_Node()
        self.head_recursive_extension_end_linked_list_ptr = bpfsp_tree_module.BPFSP_Tree()
        self.current_recursive_extension_end_linked_list_ptr = self.head_recursive_extension_end_linked_list_ptr
        self.inc_sp_tree_functionalities = inc_sp_tree_module.INC_SP_Tree_Functionalities(self.current_recursive_extension_end_linked_list_ptr)
        self.cetables={}
        self.cetablei={}
        ...
        self.bpfsptree_root = bpfsp_tree_module.BPFSP_Tree()
    ...
    def DatabaseInput(self,input_file_name):
        f = open(input_file_name,'r')
        self.new_input = int(f.readline().strip())
        line = ""
        sid = -1
        processed_sequence = []
        value = ""
        ...
        for i in range(0,self.new_input):
            ...
            if(value == None):
                ...
                self.seq_sum_dict[sid] = sequence_summarizer_structure_module.SequenceSummarizerStructure()
    ...
    def CreatingNodeFromBPFSPTree(self, item, actual_support, projection_nodes, pass_no):
        self.bpfsptree_root.freq_seq_ex_child_nodes[item] = bpfsp_tree_module.BPFSP_Tree()
    ...
    def PrintBPFSPTree(self, bpfsptree_node, pattern,f):
        ...
        for key in bpfsptree_node.freq_item_ex_child_nodes:
            ...
            self.PrintBPFSPTree(bpfsptree_node.freq_item_ex_child_nodes[key], pattern,f)
