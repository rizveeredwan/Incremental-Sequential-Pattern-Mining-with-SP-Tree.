...
for i in range(1,counter+1):
    file1 = 'E:\Research\Incremental-Sequential-Pattern-Mining\Incremental-Sequential-Pattern-Mining-with-SP-Tree\Implementation\Dataset\Dataset14\out'+str(i)+'.txt'
